...
const galleryImages = [
  {
    ...
    alt: 'Sala Reformer KineLab con attrezzature professionali',
    title: 'Il Nostro Studio',
    description: 'Sala Reformer con attrezzature Liveness',
  ...
  {
    src: '/images/reformer-gruppo-2.jpg',
    alt: 'Lezione Reformer di gruppo KineLab',
    title: 'Reformer di Gruppo',
    description: 'Lezioni in piccoli gruppi per risultati ottimali',
    className: 'md:col-span-1 md:row-span-1',
  },
  {
    src: '/images/personal-training-1.jpg',
    alt: 'Sessione Personal Training KineLab',
    title: 'Personal Training',
    description: 'Attenzione personalizzata con il tuo trainer',
    className: 'md:col-span-1 md:row-span-1',
  },
  {
    src: '/images/studio-main-room.jpg',
    alt: 'Studio KineLab Milano sala principale',
    title: 'Lo Studio',
    description: 'Ambiente accogliente con muri in mattoni a vista',
